...
const TONE_CLASSES: Record<Tone, string> = {
  ...
  neutral:
    "bg-[var(--color-surface-raised)] text-[var(--color-ink-dim)] border-[var(--color-border-bright)]",
...
export function Button({
  ...
  const variants = {
    primary:
      "bg-[var(--color-accent)] text-[#04121f] hover:brightness-110",

    secondary:
      "border border-[var(--color-border-bright)] bg-[var(--color-surface-raised)] text-[var(--color-ink)] hover:border-[var(--color-accent)]/50",
